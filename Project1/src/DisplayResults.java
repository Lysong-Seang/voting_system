...
public class DisplayResults {
    ...
    /**
     * Displays the results of the election. This method prints detailed information about the election,
        ...
        if (electionType.equals("CPL")) {
            for (int i = 0; i < parties.size(); i++) {
                ...
                for (int k =0; k< arrayName.size(); k++){
                    System.out.print(arrayName.get(i).getName()+", ");
                }
            ...
            if (electionType.equals("OPL")){
                ...
                for (int i=0; i< winnerList.size(); i++){
                    System.out.println((i+1)+". "+winnerList.get(i).getName()+" ("+
                ...
                for(int j=0; j< parties.size(); j++){
                    ...
                    System.out.print(parties.get(j).getName()+" Won: "+parties.get(j).getNumAllocatedSeats()+ "seat(s)\n");
