...
public class Audit {
    ...
    private final String fileName = "auditFile.txt"; // finalized the file name
    ...
    public void audit() throws IOException {
        ...
        System.out.println("The audit file has been updated");
        } catch (Exception e) {
            System.out.println("The audit file has NOT been updated");
            throw e;
        }
